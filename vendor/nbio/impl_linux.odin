		...
		for {
			...
			for cqe in cqes[:completed] {
				...
				if is_timeout {
					...
					handle_completed(op, cqe.res, cqe.flags)
				}
			}
...
handle_completed :: proc(op: ^Operation, res: i32, cqe_flags: linux.IO_Uring_CQE_Flags = {}) {
...
// ============================================================================
// WP117 (Phase 9) — multishot recv backend. File-private, alongside enqueue and
