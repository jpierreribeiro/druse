...
URUQUIM_SUITE="$URUQUIM_ROOT/tests/c1-status-codes/status_codes_test.odin"
...
test -f "$URUQUIM_SUITE" || fail "tests/c1-status-codes/status_codes_test.odin is missing"
env ODIN_ROOT="$URUQUIM_ODIN_DIR" "$URUQUIM_ODIN" test "$URUQUIM_ROOT/tests/c1-status-codes" \
